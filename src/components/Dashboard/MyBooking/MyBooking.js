...
export default function MyBooking() {
  ...
  useEffect(() => {
    Axios.get(`https://quiet-spire-34698.herokuapp.com/booking/${loggedInUser.email}`).then((res) => {
        ...
        <div className="col-md-9 desktop col-sm-8 col-lg-9">
          <Row className="BookingContainer">
            ...
            >
              ...
              <Row className=" justify-content-between align-items-center p-2 mt-2 text-center" style={{ fontSize: "0.89em", width: "98%" }}>
                {!userBookings ? (
                  <p>Loading..</p>
                ) : (
