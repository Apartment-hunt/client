            ...
            <Card.Body>
              ...
              <Form onSubmit={handleSubmit} className="mt-5">
                ...
                <div className="d-flex justify-content-between">
                  <Form.Group>
                    <Form.Check label="Remember Me" feedback="You must agree before submitting." />
                  </Form.Group>
                  <Form.Group>
                    <Link to="" onClick={() => passwordReset(user.email)} style={{ color: "#275a53" }}>
                      Forgot Password
                    </Link>
                  </Form.Group>
                </div>
                ...
                <Form.Text className="text-center mt-3" style={{ fontSize: "17px" }}>
                  Don't have account?
                  <Link to="/register" style={{ color: "#275a53" }}>
                    Create an Account
                  </Link>
